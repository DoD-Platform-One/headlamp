...
![Version: 0.31.1-bb.1](https://img.shields.io/badge/Version-0.31.1--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.31.1](https://img.shields.io/badge/AppVersion-0.31.1-informational?style=flat-square) ![Maintenance Track: unknown](https://img.shields.io/badge/Maintenance_Track-unknown-red?style=flat-square)
...
| metrics.image.tag | string | `"v0.26.0"` |  |
...
| image.tag | string | `"v0.31.1"` | Container image tag, If "" uses appVersion in Chart.yaml |
